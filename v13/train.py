...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_cyclical_time', action='store_true', default=True,
                        help='v13: add cyclical row-level time embeddings '
                             '(hour-of-day + day-of-week + month-of-year) '
                             'additively to user_dense_tok. Default ON. '
                             'Embedding modules are always constructed; this '
                             'flag only controls whether they are applied at '
                             'forward time.')
    parser.add_argument('--no_cyclical_time', dest='use_cyclical_time',
                        action='store_false',
                        help='Disable cyclical row-level time embeddings.')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_cyclical_time": args.use_cyclical_time,
    }
