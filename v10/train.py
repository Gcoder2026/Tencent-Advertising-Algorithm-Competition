...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_cyclical_time', action='store_true', default=False,
                        help='v10: add cyclical row-level time embeddings '
                             '(hour-of-day + day-of-week) additively to '
                             'user_dense_tok. Captures global wall-clock '
                             'context that per-event time buckets cannot.')
