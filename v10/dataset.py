...
class PCVRParquetDataset(IterableDataset):
    ...
    def _convert_batch(self, batch: "pa.RecordBatch") -> Dict[str, Any]:
        ...
        # v10: cyclical row-level time features derived deterministically
        # from the row's `timestamp` (UNIX seconds, UTC). Captures global
        # wall-clock context (hour-of-day, day-of-week) that the existing
        # 65-bucket time embedding (per-event recency) does NOT capture.
